...
3. **Run `spec_todo`** to analyze docs and generate spec files
   ...
   - For complex features (new APIs, DB schema changes, component architecture), AI writes a `architecture.md` draft and asks for review before generating tasks
...
└─ projects/
    └─ <feature>                   # per-feature project folder
        ...
        ├─ architecture.md               # architecture design document (created for complex features)
